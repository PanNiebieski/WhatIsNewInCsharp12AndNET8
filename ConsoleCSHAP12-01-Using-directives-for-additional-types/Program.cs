...
public class Product(int id, string name, IEnumerable<decimal> prices)
{
    public Product(int id, string name) : this(id, name, Enumerable.Empty<decimal>()) { }
    public int Id => id;
    public string Name { get; set; } = name.Trim();
    public decimal AveragePrice => prices.Any() ? prices.Average() : 4.0m;
